...
export const guardType = {
  ...
  ZodDiscriminatedUnion: (type: ZFPST): type is ZodDiscriminatedUnion<any, any, any> => type._def.typeName === "ZodDiscriminatedUnion",
...
export const guardProps = {
  ...
  ZodDiscriminatedUnion: (props: FromZodProps<ZFPST>): props is FromZodProps<ZodDiscriminatedUnion<any, any, any>> => guardType.ZodDiscriminatedUnion(props.type),
