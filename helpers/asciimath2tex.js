...
(t.prototype.setup_symbols = function () {
  (this.greek_letters = [
    ...
    (this.leftright_brackets = [{ asciimath: "|", left_tex: "\\lvert", right_tex: "\\rvert", free_tex: "|" }]),
    (this.unary_symbols = [
  ...
  (t.prototype.sort_symbols = function () {
    var t = function (t, e) {
      return (t = t.asciimath.length) > (e = e.asciimath.length) ? -1 : t < e ? 1 : 0;
    };
    this.constants.sort(t),
      this.relations.sort(t),
      this.left_brackets.sort(t),
      this.right_brackets.sort(t),
      this.leftright_brackets.sort(t),
      this.unary_symbols.sort(t),
      this.binary_symbols.sort(t);
  }),
  ...
  (t.prototype.literal = function (t) {
    if (t) return { tex: t.token, pos: t.pos, end: t.end, ttype: "literal" };
  }),
  ...
  (t.prototype.unbracket = function (t) {
    if (t) {
      ...
      return s || r
        ? { tex: "\\left " + (s = s || ".") + " " + c + " \\right " + (r = r || "."), pos: t.pos, end: t.end }
        : {
            tex: c,
            pos: t.pos,
            end: t.end,
    ...
    for (var e = "", a = []; !this.eof(t); ) {
      ...
      if (!i) {
        ...
        if (r) {
          ...
          c && (i = { tex: "" + i.tex + c.tex, pos: t, end: c.end, ttype: "expression" });
        }
      }
      if (i) e && (e += " "), (e += i.tex), (t = i.end), a.push(i);
      else if (!this.eof(t)) {
        var h = this.source(t, t + 1);
        a.push({ tex: h, pos: t, ttype: "character" }), (e += h), (t += 1);
      }
    }
    return { tex: e, exprs: a };
  }),
  ...
  (t.prototype.match = function (t, e) {
    ...
    if (a) {
      var i = a[0];
      return { token: i, pos: e, match: a, end: e + i.length, ttype: "regex" };
    }
  }),
  (t.prototype.exact = function (t, e) {
    if (((e = this.strip_space(e)), this.source(e).slice(0, t.length) == t))
      return { token: t, pos: e, end: e + t.length, ttype: "exact" };
  }),
  (t.prototype.expression_list = function (t) {
    ...
    if (e) {
      ...
      return { tex: i, pos: t, end: a, exprs: s, ttype: "expression_list" };
    }
  }),
  (t.prototype.expression = function (t) {
    ...
    if (a) {
      ...
      return i ? { tex: a.tex + " " + i.tex, pos: a.pos, end: i.end, ttype: "expression", exprs: [a, i] } : a;
    }
    for (var s = 0, r = this.non_constant_symbols; s < r.length; s += 1) {
      var c = r[s],
        h = this.exact(c, t);
      if (h) return { tex: c, pos: t, end: h.end, ttype: "constant" };
    }
  }),
  (t.prototype.negative_expression = function (t) {
    ...
    if (e && !this.other_constant(t)) {
      ...
      return a
        ? { tex: "- " + a.tex, pos: t, end: a.end, ttype: "negative_expression", dash: e, expression: a }
        : { tex: "-", pos: t, end: e.end, ttype: "constant" };
    }
  }),
  ...
  (t.prototype.intermediate = function (t) {
    ...
    if (e) {
      ...
      return a ? { tex: "" + e.tex + a.tex, pos: t, end: a.end, ttype: "intermediate", expression: e, subsup: a } : e;
    }
  }),
  (t.prototype.subsup = function (t) {
    ...
    var e,
      ...
      r = this.exact("_", t);
    r &&
      ((e = this.unbracket(this.simple(r.end)))
        ? ((i = i + "_{" + e.tex + "}"), (s = e.end))
        : ((i += "_{}"), (s = r.end)));
    var c = this.match(/^\^(?!\^)/, s);
    if (
      (c &&
        ((a = this.unbracket(this.simple(c.end)))
          ? ((i = i + "^{" + a.tex + "}"), (s = a.end))
          : ((i += "^{}"), (s = c.end))),
      r || c)
    )
      return { tex: i, pos: t, end: s, ttype: "subsup", sub: e, sup: a };
  }),
  (t.prototype.simple = function (t) {
    return (
      ...
      this.longest([
        this.matrix(t),
        this.bracketed_expression(t),
        this.binary(t),
        this.constant(t),
        this.text(t),
        this.unary(t),
        this.negative_simple(t),
      ])
    );
  }),
  (t.prototype.negative_simple = function (t) {
    ...
    if (e && !this.other_constant(t)) {
      ...
      return a
        ? { tex: "- " + a.tex, pos: t, end: a.end, ttype: "negative_simple", dash: e, expr: a }
        : { tex: "-", pos: t, end: e.end, ttype: "constant" };
    }
  }),
      ...
      if (s) {
        ...
        return {
          tex:
            ...
            " " +
            (i.is_array
              ? "\\begin{array}{" + i.column_desc + "} " + r + " \\end{array}"
  ...
  (t.prototype.matrix_contents = function (t, e) {
    ...
    for (
      var a = [], i = t, s = void 0, r = void 0, c = !1;
      !this.eof(i) && !(e ? this.leftright_bracket(i) : this.right_bracket(i));
      ...
      for (i = n.end; !this.eof(i); ) {
        ...
        if (!p) break;
        "column" == p.ttype
          ? (m.push("|"), (c = !0), null !== p.expr && (m.push("r"), o.push(p.expr)))
          : (m.push("r"), o.push(p)),
          (i = p.end);
      }
      if (!o.length) return;
    ...
    if (!(void 0 === s || (s <= 1 && a.length <= 1))) return { rows: a, end: i, column_desc: r, is_array: c };
  }),
  (t.prototype.matrix_cell = function (t) {
    ...
    if (e) {
      var a = this.expression(e.end);
      if (!a) return { ttype: "column", expr: null, pos: e.pos, end: e.end };
      var i = this.exact("|", a.end);
      if (!i) return { ttype: "column", expr: a, pos: e.pos, end: a.end };
    ...
    if (e) {
      ...
      if (a) {
        ...
        return i
          ...
          : { tex: e.tex + " " + a.tex, pos: t, end: a.end, ttype: "expression", exprs: [e, a] };
      }
      ...
      return s
        ...
        : { tex: e.tex, pos: t, end: e.end, ttype: "constant" };
    }
  ...
  (t.prototype.right_bracket = function (t) {
    ...
    for (var e = 0, a = this.right_brackets; e < a.length; e += 1) {
      ...
      if (s) return { tex: i.tex, pos: t, end: s.end, asciimath: i.asciimath, def: i, ttype: "right_bracket" };
    }
  }),
  (t.prototype.left_bracket = function (t) {
    ...
    for (var e = 0, a = this.left_brackets; e < a.length; e += 1) {
      var i = a[e],
        s = this.exact(i.asciimath, t);
      if (s) return { tex: i.tex, pos: t, end: s.end, asciimath: i.asciimath, ttype: "left_bracket" };
    }
  }),
  ...
  (t.prototype.text = function (t) {
    ...
    if (e) {
      ...
      return { tex: "\\text{" + a + "}", pos: t, end: e.end, ttype: "text", text: a };
    }
    var i = this.match(/^(?:mbox|text)\s*(\([^)]*\)?|\{[^}]*\}?|\[[^\]]*\]?)/, t);
    if (i) {
      var s = this.escape_text(i.match[1].slice(1, i.match[1].length - 1));
      return { tex: "\\text{" + s + "}", pos: t, end: i.end, ttype: "text", text: s };
    }
  }),
      ...
      if (s) {
        ...
        if (n) {
          ...
          return m
            ...
            : { tex: "" + i.tex + c + o + h + "{}", pos: t, end: n.end, ttype: "binary", op: i, arg1: n, arg2: null };
        }
        return { tex: "" + i.tex + c + h + "{}", pos: t, end: s.end, ttype: "binary", op: i, arg1: null, arg2: null };
      }
    }
  }),
  (t.prototype.unary = function (t) {
    ...
    for (var e = 0, a = this.unary_symbols; e < a.length; e += 1) {
      ...
      if (s) {
        ...
        return n
          ? { tex: "" + i.tex + c + "{" + o + "}", pos: t, end: n.end, ttype: "unary", op: s, subsup: r, arg: n }
          : { tex: "" + i.tex + c + "{}", pos: t, end: s.end, ttype: "unary", op: s, subsup: r, arg: null };
      }
    }
  }),
  (t.prototype.constant = function (t) {
    if ((void 0 === t && (t = 0), !this.right_bracket(t)))
      return this.longest([
        this.other_constant(t),
        this.greek(t),
        this.name(t),
        this.number(t),
        this.arbitrary_constant(t),
      ]);
  }),
  ...
  (t.prototype.greek = function (t) {
    ...
    var e = new RegExp("^(" + this.greek_letters.join("|") + ")"),
      a = this.match(e, t);
    if (a) return { tex: "\\" + a.token, pos: t, end: a.end, ttype: "greek" };
  }),
  ...
  (t.prototype.other_constant = function (t) {
    ...
    for (var e = 0, a = this.constants; e < a.length; e += 1) {
      var i = a[e],
        s = this.exact(i.asciimath, t);
      if (s) return { tex: "" + i.tex, pos: s.pos, end: s.end, ttype: "other_constant" };
    }
    for (var r = 0, c = this.relations; r < c.length; r += 1) {
      var h = c[r];
      if (!h.asciimath.match(/^!/)) {
        var n = this.exact("!" + h.asciimath, t);
        if (n) return { tex: "\\not " + h.tex, pos: n.pos, end: n.end, ttype: "other_constant" };
      }
    }
  }),
  (t.prototype.arbitrary_constant = function (t) {
    if ((void 0 === t && (t = 0), !this.eof(t))) {
      ...
      for (
        var e = 0,
          a = this.non_constant_symbols.concat(
            this.left_brackets.map(function (t) {
              return t.asciimath;
            }),
      ...
      return { tex: this.source(i).slice(0, 1), pos: t, end: i + 1, ttype: "arbitrary_constant" };
    }
  });
export default t;
//# sourceMappingURL=asciimath2tex.mjs.map
