...
const Event = () => {
  ...
  return (
    <Stack spacing={6} flexBasis={600}>
      ...
      <p>
        The entirety of our tournament will be run on the Discord Platform! To join our server, you will first need to
        create an account at <a href="www.discord.com">www.discord.com</a> and then you can join the server using this
        invite link:{" "}
      ...
      {student.waiverSigned && (
        <ButtonLink href={`/student/smt21/tests`} colorScheme="blue" size="lg">
      ...
      <p>
        During SMT, you will have the option of selecting between either the General Test, or any two Subject Tests for
        the Individual Portion. Please select the test you would like to take below. For more information about the
        format of the competition, please refer to our website at{" "}
        ...
        <>
          {student.parentEmail && student.birthdate && student.gender ? (
            ...
            <p>
              ...
              information by Friday, April 9th. The deadline for waivers to be completed is tournament day, before any
              of your tests begin. The waiver will be sent directly to your parent’s email for them to complete. Please
              allow up to two days for waivers to be sent.
            </p>
          )}
          <ParentEmailForm
