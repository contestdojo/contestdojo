...
const TestCard = ({
  ...
  return (
    <Card as={HStack} p={4} key={id}>
      ...
      <TooltipLink label="Edit Problems" href={`/admin/${entityId}/smt21/tests/${id}`}>
        <IconButton as="a" icon={<HiPencilAlt />} />
      </TooltipLink>

      <TooltipLink label="Edit Clarifications" href={`/admin/${entityId}/smt21/tests/${id}/clarifications`}>
        <IconButton as="a" icon={<HiSpeakerphone />} />
      </TooltipLink>

      <TooltipLink label="Grade Tests" href={`/admin/${entityId}/smt21/tests/${id}/grade`}>
        <IconButton as="a" icon={<HiClipboardCheck />} />
      </TooltipLink>

      <TooltipLink label="View Results" href={`/admin/${entityId}/smt21/tests/${id}/submissions`}>
