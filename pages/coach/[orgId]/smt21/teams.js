  ...
  return (
    <Stack spacing={4}>
      ...
      <p>
        ...
        Upon creation of their account, students will be prompted to add their parent’s email address. Required waivers
        will be sent directly to parents. Please add students to your teams and have them input their information by
        Friday, April 9th. The deadline for waivers to be completed is tournament day, before students take any tests.
        Students will not be permitted to compete if they do not have a completed waiver by competition day.
      </p>
      <p>
        Students are required to be (i) high school students, (ii) aged 14 years or older, and (iii) currently in the
        United States. <b>By adding a student to my team, I certify that they satisfy these requirements.</b>
      </p>
      <Wrap
        spacing={0}
  ...
  if (eventOrg.maxTeams + eventOrg.maxTeamsSapling == 0) {
    return (
      <Stack spacing={6} flex={1}>
        ...
        <Divider />
        <p>
          Unfortunately, your application for the tournament was not accepted. If you have any questions, feel free to
          email the SMT team at stanford.math.tournament@gmail.com.
        </p>
      </Stack>
    );
  }
      ...
      <Stack spacing={6} flex={1}>
        ...
        <Stack spacing={4}>
          <p>
            ...
            {eventOrg.maxTeamsSapling} teams in the Sapling division. You may now create teams and add students to
            teams.
          </p>
          <p>
            The Tree division is for teams that will participate in all rounds of the competition: Power, Team, Guts,
            and Individual subject tests. The Sapling divisions is for teams that will participate in all rounds except
            Power: Team, Guts, and Individual.
          </p>
          <p>
            ...
            . The cost for participation at SMT is $10 per individual for both divisions. The payment deadline is
            Friday, April 9th. Coaches must pay for all individuals in their organization. Please purchase the tickets
            with the email that you used for registration. When you purchase tickets, you will be asked to list the
            attendees. It is okay if the attendees listed on your registration do not match the final list of students
            participating.
          </p>
          <p>
            You have currently paid for {eventOrg.paidStudents ?? 0} individuals. Please allow up to one week for
            payment to reflect on this dashboard.
          </p>
          <p>
            ...
            . If you have any questions, feel free to email the SMT team at stanford.math.tournament@gmail.com.
          </p>
        </Stack>
        <Divider />
        {eventOrg.maxTeams > 0 && (
